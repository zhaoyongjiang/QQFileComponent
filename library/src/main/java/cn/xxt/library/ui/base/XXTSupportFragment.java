 ...
 */
public class XXTSupportFragment extends BaseFragment implements ISupportFragment {
    ...
    public void onSupportVisible() {
        ...
        try {
            ...
            Log.e("luxy", "onSupport--Visible: " + className);
        } catch (Exception e) {
    ...
    public void onSupportInvisible() {
        ...
        try {
            String className = getClass().getSimpleName();
            Log.e("luxy", "onSupport--Invisible: " + className);
        } catch (Exception e) {
