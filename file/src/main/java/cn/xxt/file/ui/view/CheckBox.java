...
import cn.xxt.file.util.SystemUtil;
    ...
    public CheckBox(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        normalColor =
                a.getColor(R.styleable.CheckBox_checkbox_color,
                        getResources().getColor(R.color.stress_clickable));
        unCheckedColor =
                a.getColor(R.styleable.CheckBox_unchecked_color,
                        getResources().getColor(R.color.stress_text));
        disabledColor =
                a.getColor(R.styleable.CheckBox_disabled_color,
                        getResources().getColor(R.color.weaken_divider_block_with_text));
        borderColor =
